...
CI checks SDK and server imports in separate minimal environments, then runs
SQLite/Moto tests, PostgreSQL and pinned-MinIO integration tests, and the existing
HF²L regression suite. Local source checks can be run with:
